...
frame_titulo.config(bg="grey13", width=200, height=290)
frame_titulo.place(x=300,y=0)

frame_resultado=Frame(ventana)
frame_resultado.config(bg='black', width=800,height=250)
frame_resultado.place(x=0,y=290)


titulo = Label(frame_titulo, text="ECUACIONES DE")
titulo.config(bg="grey13", fg="white", font=("Arial", 16))
titulo.place(x=10,y=20)

titulo2=Label(frame_titulo,text='SEGUNDO 2° grado')
titulo2.config(bg='red', fg='white',font=('Arial',16))
titulo2.place(x=-2,y=60)

A=Label(ventana,text='A =')
A.config(bg='red',fg='white',font=('Arial',25))
A.place(x=10,y=40)

B=Label(ventana,text='B =')
B.config(bg='red',fg='white',font=('Arial',25))
B.place(x=10,y=100)

C=Label(ventana,text='C =')
C.config(bg='red',fg='white',font=('Arial',25))
C.place(x=10,y=160)
...
boton.config(bg='red',fg= 'white',font=('Arial',25))
